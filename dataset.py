...
#from util import config, vongani-VivoBook-15-ASUS-Laptop-X540UAR
...
class HazeData(data.Dataset):
    ...
    def _get_idx(self,t):
        t0 = self.data_start
        return int((t.timestamp() - t0.timestamp()) / (60 * 60 * 1))
